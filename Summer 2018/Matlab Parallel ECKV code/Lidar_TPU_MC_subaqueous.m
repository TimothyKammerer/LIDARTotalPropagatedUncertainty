% This program attempts to conduct Monte Carlo algorithms much faster. 
...
AlgConst.Sim.Nsim=2000;                  % Number of MC simulations
...
AlgConst.Env.wave_age = 3.5;                % wave age used in the ECKV modeled water surface
...
for wind = AlgConst.Sim.wind_spread
    ...
    for Kd = AlgConst.Sim.Kd_spread
        ...
        save(sprintf('table_wind_%d_Kd%.2g_sig_xyz_PF%.3g_TB_right.mat',wind,Kd*100,AlgConst.Scatter.g_pf),'LUT')
    end
end
